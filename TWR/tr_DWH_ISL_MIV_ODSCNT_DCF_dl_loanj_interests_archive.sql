...
-------------------------------------------------------------------------------------------------------
--select * from #phiz_uric_accs cc where cc.RootID like '16787%'
-----------------------------------------------------
...
, sub_full_with_transhes.ICDQPART
----------------------------------------
--select * from #full_from_cda_with_transches ff where ff.NCDAAGRID like '140000134%'
--------------------------------------------------------
...
, sub_full_without_transhes.ICDQPART
---------------------------------------------
--select * from #full_from_cda_without_transches fcd where fcd.NCDAAGRID like '16787%'
-------------------------------------------------------------
...
-------------------------------
--select * from #firstTranshDate ftd where ftd.RootID like '16787%'
--------------------------------------------------------------------------------------------------------
...
----------------------------------
--select * from #full_select fs where fs.CONTRACT_ID like '%16787%'
----------------------------------------------------------------------------------------------------------------
